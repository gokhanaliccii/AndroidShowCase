        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/gokhanaliccii/androidshowcase/")
                    ...
                    developers {
                        developer {
                            id.set("gokhanaliccii")
                            name.set("gokhanaliccii")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/gokhanaliccii/androidshowcase.git")
                        developerConnection.set("scm:git:ssh://github.com/gokhanaliccii/androidshowcase.git")
                        url.set("https://github.com/gokhanaliccii/androidshowcase/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/gokhanaliccii/androidshowcase/issues")
                    }
                }
            }
        }
